// ============================================
// منصة القيصر - الأستاذ هشام أبو العنين
...
const firstYearVideos = [
  // مثال على إضافة فيديو جديد - قم بإلغاء التعليق وإضافة فيديوهاتك:
  // {
  //   title: "مقدمة في التاريخ - الحضارة المصرية القديمة",
  //   duration: "35 دقيقة",
  //   videoUrl: "https://www.youtube.com/watch?v=XXXXXXXXXXX",
  //   thumbnail: "",
  //   description: "شرح مبسط لنشأة الحضارة المصرية وأهم معالمها"
  // }
];

// فيديوهات الصف الثاني الثانوي
const secondYearVideos = [
  // أضف فيديوهات الصف الثاني الثانوي هنا
];

// فيديوهات الصف الثالث الثانوي
const thirdYearVideos = [
  // أضف فيديوهات الصف الثالث الثانوي هنا
];
  ...
  if (!videos || videos.length === 0) {
    container.innerHTML = `
      <div style="text-align: center; padding: 3rem; background: white; border-radius: 20px;">
        <i class="fas fa-video" style="font-size: 3rem; color: #d4af37; margin-bottom: 1rem; display: block;"></i>
        <h3 style="color: #2d1b0c; margin-bottom: 0.5rem;">لا توجد فيديوهات حالياً</h3>
        <p style="color: #7a5a3a;">سيتم إضافة فيديوهات ${stageName} قريباً</p>
        <p style="color: #7a5a3a; margin-top: 1rem; font-size: 0.9rem;">يمكنك إضافة الفيديوهات من خلال ملف script.js</p>
      </div>
    `;
    return;
  }
        ...
        <div class="video-card">
          <div class="video-thumbnail" onclick="openVideoModal('${video.videoUrl || ''}', '${video.title.replace(/'/g, "\\'")}')">
            ${video.thumbnail ? 
              ...
              `<div style="width:100%;height:100%;background:linear-gradient(135deg,#1e2a2e,#2d1b0c);display:flex;align-items:center;justify-content:center;">
                 <i class="fas fa-play-circle" style="font-size: 4rem; color: #d4af37;"></i>
               </div>`
            }
